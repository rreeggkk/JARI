...
public class BlockRecipeRegistry {
	...
	private static void registerShapedRecipes() {
		GameRegistry.addShapedRecipe(
				new ItemStack(BlockRegistry.blockHydraulicSeparator),
				"iti", // Invar Tank Invar
				"hph", // HGlass Pulverizer HGlass
				"ele", // Electrum BasicCell Electrum
				'i', TFItems.ingotInvar, 't', BlockTank.tankBasic, 'h',
				BlockGlass.glassHardened, 'p', BlockMachine.pulverizer, 'e',
				TFItems.ingotElectrum, 'l', BlockCell.cellBasic);
	}

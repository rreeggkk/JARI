...
public class GuiHydraulicSeparator extends JARIGuiScreen<ContainerHydraulicSeparator> {
	...
	public GuiHydraulicSeparator(ContainerHydraulicSeparator container) {
		...
		{
			GuiJARI mainScreen = new MainGui(this);
			mainScreen.elements.add(new GuiEnergyMeter(151, 6, 18, this, container.tile));
			mainScreen.elements.add(new GuiFluidTank(6, 6, 18, this, container.tile.getTank()));
			mainScreen.elements.add(new GuiTabRedstoneControl(xSize, 5, 18, 18, "jari.gui.element.redstoneControl", this, container.tile, 0).setTextDirection(true));
